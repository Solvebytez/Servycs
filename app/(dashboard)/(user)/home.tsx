...
import { COLORS, FONT_SIZE, MARGIN, PADDING, SPACING } from '../../../constants';
...
export default function UserHomeScreen() {
  ...
  const serviceCategories = [
    ...
    { id: '6', title: 'Repairs & Services', icon: 'construct', color: '#FFA500' }
  ];
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerIcons}>
              ...
              <TouchableOpacity style={styles.profileButton}>
                <ResponsiveText variant="buttonSmall" weight="bold" color={COLORS.black}>
                  RB
                </ResponsiveText>
              </TouchableOpacity>
            </View>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <ResponsiveText variant="h4" weight="bold" color={COLORS.text.primary}>
            ...
            >
              {favoriteServices.map((service) => (
                <TouchableOpacity key={service.id} style={styles.favoriteServiceCard}>
                  <View style={styles.serviceImageContainer}>
                    <Image 
                      ...
                      resizeMode="cover"
                    />
                    <View style={[styles.serviceOverlay, { backgroundColor: service.color }]}>
                      <ResponsiveText variant="body2" weight="bold" color={COLORS.white}>
                        {service.title}
                      </ResponsiveText>
                    </View>
                  </View>
          ...
          <View style={styles.section}>
            <ResponsiveText variant="h4" weight="bold" color={COLORS.text.primary} style={styles.sectionTitle}>
              Recent Activities
            </ResponsiveText>
          ...
          <View style={styles.section}>
            ...
            <ResponsiveText variant="body2" color={COLORS.text.secondary} style={styles.featureText}>
              Discover amazing services, book appointments, and manage your activities all in one place. 
              Our app provides a seamless experience for all your needs.
            </ResponsiveText>
          </View>
          ...
          <View style={styles.section}>
            ...
            <ResponsiveText variant="body2" color={COLORS.text.secondary} style={styles.featureText}>
              ...
              Contact us through the app or call our helpline.
            </ResponsiveText>
          </View>
          ...
          <View style={styles.section}>
            ...
            <ResponsiveText variant="body2" color={COLORS.text.secondary} style={styles.featureText}>
              Your privacy and security are our top priorities. All your data is encrypted and protected 
              according to industry standards. We never share your personal information with third parties.
            </ResponsiveText>
          </View>
          ...
          <View style={styles.section}>
            ...
            <ResponsiveText variant="body2" color={COLORS.text.secondary} style={styles.featureText}>
              ...
              Please read them carefully before proceeding with any transactions or bookings.
            </ResponsiveText>
          </View>
